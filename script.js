...
function show_score() {
  if (localStorage.getItem("first") == null) {
    ...
    //   window.alert(
    //     "Rod 1 won with " +
    //       localStorage.getItem("current_first").toString() +
    //       " and Rod 1 has maximum score of " +
    //       localStorage.getItem("first").toString()
    //   );
    // } else {
    //   window.alert(
    //     "Rod 2 won with and Rod 2 has maximum score of " +
    //       localStorage.getItem("first").toString()
    //   );
    // }
  }
